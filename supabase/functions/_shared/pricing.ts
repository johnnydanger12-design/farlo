...
// platform.claude.com/docs/en/about-claude/pricing (checked Jul 2 2026). This is an
// estimate reconstructed from token counts we log ourselves, not a reconciliation
// against Anthropic's actual invoice — good enough for "roughly what is this costing
// me" in a weekly brief, not precise to the cent.
//
...
// but if pricing changes again after that, update SONNET_5_STANDARD (and re-check
// Haiku 4.5, which has no announced change as of this writing).
