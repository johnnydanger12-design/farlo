...
// (Sonnet 5/Haiku 4.5 checked Jul 2 2026; Opus 4.8/Fable 5 added checked Jul 8 2026),
// reconstructed from token counts logged by the agents themselves — an estimate, not a
// reconciliation against Anthropic's actual invoice.
